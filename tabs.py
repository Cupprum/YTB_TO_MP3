...
nazov_album.grid(row=1, column=3, sticky=W, pady=4)
entry_album = Entry(tab2)
entry_album.grid(row=1, column=4, sticky=W, pady=4)
button_album = Button(tab2, text='Album', command=pridat_mp4)
button_album.grid(row=1, column=6, sticky=W, pady=4)
nazov_txtfile = Label(tab2, text='Txtfile: ')
nazov_txtfile.grid(row=2, column=3, sticky=W, pady=4)
entry_txtfile = Entry(tab2)
entry_txtfile.grid(row=2, column=4, sticky=W, pady=4)
button_txtfile = Button(tab2, text='Textfile', command=pridat_txtfile)
button_txtfile.grid(row=2, column=6, sticky=W, pady=4)
nazov1_syntax = Label(tab2, text='Zadaj vlstnu syntax')
nazov1_syntax.grid(row=3, column=3, sticky=W, pady=4)
entry_syntax = Entry(tab2)
entry_syntax.grid(row=3, column=4, sticky=W, pady=4)
button_syntax = Button(tab2, text='Vypocet', command=vypocet)
button_syntax.grid(row=3, column=6, sticky=W, pady=4)
nazov1_syntax = Label(tab2, text='Povodna syntax: meno, zaciatok pesnicky, koniec pesnicky')
nazov1_syntax.grid(row=4, column=3, columnspan=2, sticky=W, pady=4)
